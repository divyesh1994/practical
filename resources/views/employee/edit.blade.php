        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('employee.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{ $employee->title }}" class="form-control input-sm">
                    @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" class="form-control input-sm" value="{{ $employee->first_name }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="last_name" class="form-control input-sm" value="{{$employee->last_name }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-control input-sm" value="{{ $employee->phone }}">
                    @if ($errors->has('phone'))
